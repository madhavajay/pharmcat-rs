...
- Next unblocked slice:
  ...
  - Port Java `PipelineTest.testUgt1a1s28s80phased`, covering phased UGT1A1 `*1/*80+*28` plus atazanavir CPIC/DPWG matched-annotation counts and `UGT1A1` gene-message assertions.
