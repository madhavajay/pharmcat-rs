...
- Next unblocked slice:
  ...
  - Port Java `PipelineTest.testUgt1a1s1s80s27s60s28MissingPhased` (phased, `rs3064744` missing, `rs887829` `T/C`, `rs35350960` `A/C`), a NoCall case that also asserts the report stays phased (`isPhased()`).
