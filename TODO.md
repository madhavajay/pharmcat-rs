...
- Next unblocked slice:
  ...
  - Port Java `PipelineTest.testUgt1a1s6s60s80s28MissingPhased`, covering a missing `rs3064744` that yields three candidate calls (`*6/*80`, `*6/*80+*28`, `*6/*80+*37`) — the first UGT1A1 multi-call/partial-match pipeline slice.
